...
import dev.tushar.forge.githubinstallation.AutonomyLevel;
...
/**
 * A repository a human has explicitly told Forge to maintain.
 *
...
public class ManagedRepository {
    ...
    /** Whether Forge is currently maintaining this repository, and if not, why not. */
    public enum Status {
        ACTIVE,
        PAUSED,
    ...
    /**
     * Stops Forge maintaining this repository.
     *
