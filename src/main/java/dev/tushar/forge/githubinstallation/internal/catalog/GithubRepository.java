...
/**
 * A repository the installation exposes to Forge — <em>available</em>, not maintained.
 *
...
public class GithubRepository {
    ...
    /**
     * When Forge stopped being able to see this repository.
     *
     * <p>Set rather than deleted. A customer must never discover that Forge quietly lost access
    ...
    /** Absent from the latest sync: Forge can no longer see it. */
