 ...
 *
 * <p>Forge's default is <em>not</em> to introduce interfaces. An abstraction must answer to a
 ...
 * </ol>
 *
 * <p>Enforced by {@code AbstractionHygieneTest}: any interface under {@code dev.tushar.forge} that
