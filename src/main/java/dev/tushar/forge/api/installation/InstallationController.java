package dev.tushar.forge.api.installation;

import dev.tushar.forge.githubinstallation.InstallationBinding;
import dev.tushar.forge.githubinstallation.InstallationBindingResult;
import dev.tushar.forge.githubinstallation.InstallationBindingService;
...
class InstallationController {
    ...
    InstallationController(
            ...
            @Value("${forge.github.app.slug:}") String appSlug,
            @Value("${forge.github.app.setup-redirect:/}") String setupRedirect) {
     ...
     */
    @GetMapping("/start")
    ResponseEntity<Void> start(@AuthenticationPrincipal ForgePrincipal principal) {
    ...
    ResponseEntity<Void> callback(
            ...
            @AuthenticationPrincipal ForgePrincipal principal) {
