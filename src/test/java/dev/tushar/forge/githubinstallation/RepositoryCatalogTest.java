...
import dev.tushar.forge.support.FakeGithub.Repo;
...
class RepositoryCatalogTest extends AbstractGithubAppTest {
     ...
     * created managed rows, a user granting access to thirty repositories would find Forge working
     * on all thirty.
     */
    @Test
    ...
    /**
     * Losing access to something Forge was maintaining has to be loud.
     *
     * <p>A customer must never discover that Forge quietly stopped maintaining a repository three
